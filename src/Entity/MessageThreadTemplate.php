 ...
 *   handlers = {
 *     "form" = {
 *       "add" = "Drupal\message_private\Form\MessageThreadTemplateForm",
 *       "edit" = "Drupal\message_private\Form\MessageThreadTemplateForm",
 *       "delete" = "Drupal\message_private\Form\MessageThreadTemplateDeleteConfirm"
 *     },
 *     "list_builder" = "Drupal\message_private\MessageThreadTemplateListBuilder",
 *     "view_builder" = "Drupal\message_private\MessageThreadViewBuilder",
 *   },
 *   links = {
 *     "add-form" = "/admin/structure/thread/template/add",
 *     "edit-form" = "/admin/structure/thread/manage/{message_thread_template}",
 *     "delete-form" = "/admin/structure/thread/delete/{message_thread_template}"
 *   },
 *   config_export = {
 *     "template",
 *     "label",
